...
* `F8` to toggle the trigger prediction, its not perfect but it works :3 (on by default)

### Disclaimer

* Servers with shavit_core_hijack_teleport_angles set to "1" make trigger_teleports rubberband you, however, the timer defaults this to 0 now.
...
### Cloning & building
- `git clone --recurse-submodules https://github.com/bhopbhopbhop/RawInput2BunnyhopAPE-lagfix.git`
